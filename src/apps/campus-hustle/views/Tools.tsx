        ...
        <NeuCard className="p-6 md:col-span-2">
            ...
            <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="relative">
                    ...
                    <div className={`relative p-4 h-full rounded-xl flex items-center justify-center text-blue-800 dark:text-blue-300 italic text-sm font-medium ${!feedback ? 'opacity-50 !text-slate-500' : ''}`}>
