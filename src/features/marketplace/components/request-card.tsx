...
export function RequestCard({
  ...
  return (
    <Card className="space-y-2 flex flex-col w-full border-0 bg-gray-50 hover:shadow-md transition-all duration-300">
      <img
        src={request.image || "/marketplace/logo.svg"}
        alt="Product image"
      ...
      <div className="flex-1">
        <CardTitle className="px-6 my-2 flex items-center justify-between">
          ...
          <Button
            ...
            className="flex items-center gap-2 bg-primary text-white hover:bg-market-accent"
          >
      ...
      <div className="p-5 pt-0 space-y-3">
        ...
        <div className="w-full">
          {type === "profile" ? (
            ...
            <Dialog>
              <DialogTrigger className="flex items-center gap-2 bg-primary text-white hover:bg-market-accent w-full py-2 justify-center rounded-md">
                <Contact /> Contact
              </DialogTrigger>
              <DialogContent>
                <DialogHeader>
