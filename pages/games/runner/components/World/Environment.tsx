...
const RetroSun: React.FC = () => {
    ...
    const uniforms = useMemo(() => ({
        uTime: { value: 0 },
        uColorTop: { value: new THREE.Color('#bef264') }, // Lime 300
        uColorBottom: { value: new THREE.Color('#065f46') } // Emerald 800
    }), []);
...
export const Environment: React.FC = () => {
  return (
    <>
      <color attach="background" args={['#021a0f']} />
      <fog attach="fog" args={['#021a0f', 40, 160]} />
      
      <ambientLight intensity={0.4} color="#064e3b" />
      <directionalLight position={[0, 20, -10]} intensity={1.5} color="#34d399" />
      <pointLight position={[0, 25, -150]} intensity={2} color="#10b981" distance={200} decay={2} />
